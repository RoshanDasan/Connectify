import{c as xt,j as x,r as _,R as z,O as un,q as oe,a as dn,u as fn,P as hn,Q as pn,A as mn}from"./index-fa71e287.js";import{a as vn,s as gn,b as bn}from"./chatConnection-33526e16.js";import{g as Ct}from"./userConnection-85ac333b.js";import{F as ve}from"./DisplayFlex-d5348167.js";import{A as _e}from"./Avatar-500fb514.js";import{t as ue,N as _n}from"./Navbar-bf3c7e0b.js";import{T as We,I as Ee,k as yn}from"./api-1f210189.js";import{S as wn}from"./Send-068a8eb6.js";import"./MenuItem-505607bc.js";import"./FormControl-e2622945.js";const kn=xt([x.jsx("circle",{cx:"12",cy:"12",r:"3.2"},"0"),x.jsx("path",{d:"M9 2 7.17 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z"},"1")],"PhotoCamera"),xn=xt(x.jsx("path",{d:"M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4zM14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2z"}),"VideoCall");const Cn=({data:e,userId:t,token:n,online:r})=>{const[i,o]=_.useState(null);return _.useEffect(()=>{const s=e.members.find(c=>c!==t);(async()=>{try{const c=await Ct(s,n);o(c)}catch(c){throw c}})()},[]),x.jsx(x.Fragment,{children:x.jsx("div",{className:"chat-header",children:x.jsx("div",{className:"follower",children:x.jsxs(ve,{sx:{justifyContent:"flex-start"},children:[i!=null&&i.dp?x.jsxs("div",{className:"profile-picture",children:[r&&x.jsx("div",{className:"online-dot"}),x.jsx(_e,{alt:i.userName,src:`http://localhost:5000/uploads/${i.dp}`,sx:{mr:"10px"}})]}):x.jsx(_e,{alt:i==null?void 0:i.userName,sx:{m:"10px"}}),x.jsx("div",{className:"name",style:{fontSize:"0.8rem"}}),x.jsxs("div",{style:{display:"flex",flexDirection:"column"},children:[x.jsx("span",{children:i==null?void 0:i.userName}),x.jsx("span",{children:r?"online":"offline"})]})]})})})})};var $n=["second","minute","hour","day","week","month","year"];function Sn(e,t){if(t===0)return["just now","right now"];var n=$n[Math.floor(t/2)];return e>1&&(n+="s"),[e+" "+n+" ago","in "+e+" "+n]}var jn=["秒","分钟","小时","天","周","个月","年"];function En(e,t){if(t===0)return["刚刚","片刻后"];var n=jn[~~(t/2)];return[e+" "+n+"前",e+" "+n+"后"]}var Ae={},$t=function(e,t){Ae[e]=t},Ln=function(e){return Ae[e]||Ae.en_US},Le=[60,60,24,7,365/7/12,12];function qe(e){return e instanceof Date?e:!isNaN(e)||/^\d+$/.test(e)?new Date(parseInt(e)):(e=(e||"").trim().replace(/\.\d+/,"").replace(/-/,"/").replace(/-/,"/").replace(/(\d)T(\d)/,"$1 $2").replace(/Z/," UTC").replace(/([+-]\d\d):?(\d\d)/," $1$2"),new Date(e))}function Mn(e,t){var n=e<0?1:0;e=Math.abs(e);for(var r=e,i=0;e>=Le[i]&&i<Le.length;i++)e/=Le[i];return e=Math.floor(e),i*=2,e>(i===0?9:1)&&(i+=1),t(e,i,r)[n].replace("%s",e.toString())}function zn(e,t){var n=t?qe(t):new Date;return(+n-+qe(e))/1e3}var Rn=function(e,t,n){var r=zn(e,n&&n.relativeDate);return Mn(r,Ln(t))};$t("en_US",Sn);$t("zh_CN",En);function Pn(e,t){t===void 0&&(t={});var n=t.insertAt;if(!(!e||typeof document>"u")){var r=document.head||document.getElementsByTagName("head")[0],i=document.createElement("style");i.type="text/css",n==="top"&&r.firstChild?r.insertBefore(i,r.firstChild):r.appendChild(i),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(document.createTextNode(e))}}var An=`.react-input-emoji--container {
  color: #4b4b4b;
...
`;Pn(An);function Ke(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function Ge(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?Ke(Object(n),!0).forEach(function(r){Tn(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):Ke(Object(n)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function de(){/*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */de=function(){return e};var e={},t=Object.prototype,n=t.hasOwnProperty,r=typeof Symbol=="function"?Symbol:{},i=r.iterator||"@@iterator",o=r.asyncIterator||"@@asyncIterator",s=r.toStringTag||"@@toStringTag";function l(b,p,$){return Object.defineProperty(b,p,{value:$,enumerable:!0,configurable:!0,writable:!0}),b[p]}try{l({},"")}catch{l=function(p,$,E){return p[$]=E}}function c(b,p,$,E){var S=p&&p.prototype instanceof m?p:m,T=Object.create(S.prototype),A=new V(E||[]);return T._invoke=function(F,W,P){var I="suspendedStart";return function(U,ee){if(I==="executing")throw new Error("Generator is already running");if(I==="completed"){if(U==="throw")throw ee;return B()}for(P.method=U,P.arg=ee;;){var he=P.delegate;if(he){var re=C(he,P);if(re){if(re===a)continue;return re}}if(P.method==="next")P.sent=P._sent=P.arg;else if(P.method==="throw"){if(I==="suspendedStart")throw I="completed",P.arg;P.dispatchException(P.arg)}else P.method==="return"&&P.abrupt("return",P.arg);I="executing";var te=u(F,W,P);if(te.type==="normal"){if(I=P.done?"completed":"suspendedYield",te.arg===a)continue;return{value:te.arg,done:P.done}}te.type==="throw"&&(I="completed",P.method="throw",P.arg=te.arg)}}}(b,$,A),T}function u(b,p,$){try{return{type:"normal",arg:b.call(p,$)}}catch(E){return{type:"throw",arg:E}}}e.wrap=c;var a={};function m(){}function d(){}function v(){}var h={};l(h,i,function(){return this});var y=Object.getPrototypeOf,g=y&&y(y(le([])));g&&g!==t&&n.call(g,i)&&(h=g);var k=v.prototype=m.prototype=Object.create(h);function L(b){["next","throw","return"].forEach(function(p){l(b,p,function($){return this._invoke(p,$)})})}function w(b,p){function $(S,T,A,F){var W=u(b[S],b,T);if(W.type!=="throw"){var P=W.arg,I=P.value;return I&&typeof I=="object"&&n.call(I,"__await")?p.resolve(I.__await).then(function(U){$("next",U,A,F)},function(U){$("throw",U,A,F)}):p.resolve(I).then(function(U){P.value=U,A(P)},function(U){return $("throw",U,A,F)})}F(W.arg)}var E;this._invoke=function(S,T){function A(){return new p(function(F,W){$(S,T,F,W)})}return E=E?E.then(A,A):A()}}function C(b,p){var $=b.iterator[p.method];if($===void 0){if(p.delegate=null,p.method==="throw"){if(b.iterator.return&&(p.method="return",p.arg=void 0,C(b,p),p.method==="throw"))return a;p.method="throw",p.arg=new TypeError("The iterator does not provide a 'throw' method")}return a}var E=u($,b.iterator,p.arg);if(E.type==="throw")return p.method="throw",p.arg=E.arg,p.delegate=null,a;var S=E.arg;return S?S.done?(p[b.resultName]=S.value,p.next=b.nextLoc,p.method!=="return"&&(p.method="next",p.arg=void 0),p.delegate=null,a):S:(p.method="throw",p.arg=new TypeError("iterator result is not an object"),p.delegate=null,a)}function M(b){var p={tryLoc:b[0]};1 in b&&(p.catchLoc=b[1]),2 in b&&(p.finallyLoc=b[2],p.afterLoc=b[3]),this.tryEntries.push(p)}function O(b){var p=b.completion||{};p.type="normal",delete p.arg,b.completion=p}function V(b){this.tryEntries=[{tryLoc:"root"}],b.forEach(M,this),this.reset(!0)}function le(b){if(b){var p=b[i];if(p)return p.call(b);if(typeof b.next=="function")return b;if(!isNaN(b.length)){var $=-1,E=function S(){for(;++$<b.length;)if(n.call(b,$))return S.value=b[$],S.done=!1,S;return S.value=void 0,S.done=!0,S};return E.next=E}}return{next:B}}function B(){return{value:void 0,done:!0}}return d.prototype=v,l(k,"constructor",v),l(v,"constructor",d),d.displayName=l(v,s,"GeneratorFunction"),e.isGeneratorFunction=function(b){var p=typeof b=="function"&&b.constructor;return!!p&&(p===d||(p.displayName||p.name)==="GeneratorFunction")},e.mark=function(b){return Object.setPrototypeOf?Object.setPrototypeOf(b,v):(b.__proto__=v,l(b,s,"GeneratorFunction")),b.prototype=Object.create(k),b},e.awrap=function(b){return{__await:b}},L(w.prototype),l(w.prototype,o,function(){return this}),e.AsyncIterator=w,e.async=function(b,p,$,E,S){S===void 0&&(S=Promise);var T=new w(c(b,p,$,E),S);return e.isGeneratorFunction(p)?T:T.next().then(function(A){return A.done?A.value:T.next()})},L(k),l(k,s,"Generator"),l(k,i,function(){return this}),l(k,"toString",function(){return"[object Generator]"}),e.keys=function(b){var p=[];for(var $ in b)p.push($);return p.reverse(),function E(){for(;p.length;){var S=p.pop();if(S in b)return E.value=S,E.done=!1,E}return E.done=!0,E}},e.values=le,V.prototype={constructor:V,reset:function(b){if(this.prev=0,this.next=0,this.sent=this._sent=void 0,this.done=!1,this.delegate=null,this.method="next",this.arg=void 0,this.tryEntries.forEach(O),!b)for(var p in this)p.charAt(0)==="t"&&n.call(this,p)&&!isNaN(+p.slice(1))&&(this[p]=void 0)},stop:function(){this.done=!0;var b=this.tryEntries[0].completion;if(b.type==="throw")throw b.arg;return this.rval},dispatchException:function(b){if(this.done)throw b;var p=this;function $(W,P){return T.type="throw",T.arg=b,p.next=W,P&&(p.method="next",p.arg=void 0),!!P}for(var E=this.tryEntries.length-1;E>=0;--E){var S=this.tryEntries[E],T=S.completion;if(S.tryLoc==="root")return $("end");if(S.tryLoc<=this.prev){var A=n.call(S,"catchLoc"),F=n.call(S,"finallyLoc");if(A&&F){if(this.prev<S.catchLoc)return $(S.catchLoc,!0);if(this.prev<S.finallyLoc)return $(S.finallyLoc)}else if(A){if(this.prev<S.catchLoc)return $(S.catchLoc,!0)}else{if(!F)throw new Error("try statement without catch or finally");if(this.prev<S.finallyLoc)return $(S.finallyLoc)}}}},abrupt:function(b,p){for(var $=this.tryEntries.length-1;$>=0;--$){var E=this.tryEntries[$];if(E.tryLoc<=this.prev&&n.call(E,"finallyLoc")&&this.prev<E.finallyLoc){var S=E;break}}S&&(b==="break"||b==="continue")&&S.tryLoc<=p&&p<=S.finallyLoc&&(S=null);var T=S?S.completion:{};return T.type=b,T.arg=p,S?(this.method="next",this.next=S.finallyLoc,a):this.complete(T)},complete:function(b,p){if(b.type==="throw")throw b.arg;return b.type==="break"||b.type==="continue"?this.next=b.arg:b.type==="return"?(this.rval=this.arg=b.arg,this.method="return",this.next="end"):b.type==="normal"&&p&&(this.next=p),a},finish:function(b){for(var p=this.tryEntries.length-1;p>=0;--p){var $=this.tryEntries[p];if($.finallyLoc===b)return this.complete($.completion,$.afterLoc),O($),a}},catch:function(b){for(var p=this.tryEntries.length-1;p>=0;--p){var $=this.tryEntries[p];if($.tryLoc===b){var E=$.completion;if(E.type==="throw"){var S=E.arg;O($)}return S}}throw new Error("illegal catch attempt")},delegateYield:function(b,p,$){return this.delegate={iterator:le(b),resultName:p,nextLoc:$},this.method==="next"&&(this.arg=void 0),a}},e}function Ye(e,t,n,r,i,o,s){try{var l=e[o](s),c=l.value}catch(u){n(u);return}l.done?t(c):Promise.resolve(c).then(r,i)}function Xe(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){var o=e.apply(t,n);function s(c){Ye(o,r,i,s,l,"next",c)}function l(c){Ye(o,r,i,s,l,"throw",c)}s(void 0)})}}function Tn(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Dn(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}function In(e,t){if(e==null)return{};var n=Dn(e,t),r,i;if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(i=0;i<o.length;i++)r=o[i],!(t.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(e,r)&&(n[r]=e[r])}return n}function J(e,t){return Hn(e)||Nn(e,t)||jt(e,t)||Un()}function St(e){return On(e)||Bn(e)||jt(e)||Fn()}function On(e){if(Array.isArray(e))return Te(e)}function Hn(e){if(Array.isArray(e))return e}function Bn(e){if(typeof Symbol<"u"&&e[Symbol.iterator]!=null||e["@@iterator"]!=null)return Array.from(e)}function Nn(e,t){var n=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(n!=null){var r=[],i=!0,o=!1,s,l;try{for(n=n.call(e);!(i=(s=n.next()).done)&&(r.push(s.value),!(t&&r.length===t));i=!0);}catch(c){o=!0,l=c}finally{try{!i&&n.return!=null&&n.return()}finally{if(o)throw l}}return r}}function jt(e,t){if(e){if(typeof e=="string")return Te(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);if(n==="Object"&&e.constructor&&(n=e.constructor.name),n==="Map"||n==="Set")return Array.from(e);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return Te(e,t)}}function Te(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n];return r}function Fn(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
...
`;function Nr(e){const t=_.useRef(null),n=_.useRef(null);return n.current&&n.current.update(e),_.useEffect(()=>(n.current=new Ve({...e,ref:t}),()=>{n.current=null}),[]),z.createElement("div",{ref:t})}function rn(e){var t=e.theme,n=e.onSelectEmoji,r=e.disableRecent,i=e.customEmojis,o=_.useMemo(function(){var s=[];return r||s.push("frequent"),s=[].concat(St(s),["people","nature","foods","activity","places","objects","symbols","flags"]),s},[r]);return z.createElement(Nr,{data:void 0,theme:t,previewPosition:"none",onEmojiSelect:n,custom:i,categories:o,set:"apple"})}rn.propTypes={theme:ue.oneOf(["light","dark","auto"]),onSelectEmoji:ue.func,disableRecent:ue.bool,customEmojis:ue.array};var Fr=_.memo(rn);function kt(e){var t=e.showPicker,n=e.theme,r=e.handleSelectEmoji,i=e.disableRecent,o=e.customEmojis;return z.createElement("div",{className:"react-emoji-picker--container"},t&&z.createElement("div",{className:"react-emoji-picker--wrapper",onClick:function(l){return l.stopPropagation()}},z.createElement("div",{className:"react-emoji-picker"},z.createElement(Fr,{theme:n,onSelectEmoji:r,disableRecent:i,customEmojis:o}))))}var Ur=function(t){var n=t.theme,r=t.keepOpened,i=t.disableRecent,o=t.customEmojis,s=t.addSanitizeFn,l=t.addPolluteFn,c=t.appendContent,u=t.buttonElement,a=_.useState(!1),m=J(a,2),d=m[0],v=m[1],h=_.useState(),y=J(h,2),g=y[0],k=y[1];_.useEffect(function(){s(Kn)},[s]),_.useEffect(function(){l(Et)},[l]),_.useEffect(function(){function C(M){var O=M.target;O.classList.contains("react-input-emoji--button")||O.classList.contains("react-input-emoji--button--icon")||v(!1)}return document.addEventListener("click",C),function(){document.removeEventListener("click",C)}},[]);function L(C){C.stopPropagation(),C.preventDefault(),v(function(M){return!M})}function w(C){c(qn(C)),r||v(function(M){return!M})}return _.useEffect(function(){u!=null&&u.style&&(u.style.position="relative",k(u))},[u]),g?un.createPortal(z.createElement(z.Fragment,null,z.createElement(kt,{showPicker:d,theme:n,handleSelectEmoji:w,disableRecent:i,customEmojis:o}),z.createElement(Qe,{showPicker:d,toggleShowPicker:L,buttonElement:g})),g):z.createElement(z.Fragment,null,z.createElement(kt,{showPicker:d,theme:n,handleSelectEmoji:w,disableRecent:i,customEmojis:o}),z.createElement(Qe,{showPicker:d,toggleShowPicker:L}))};function Vr(){var e=on();if(!e)return null;var t=e.text.substring(e.begin,e.end);return t||null}function Wr(){var e=on();e&&e.element.deleteData(e.begin,e.end-e.begin)}function on(){var e=Fe();if(!e)return null;var t=e.element,n=e.caretOffset,r=t.textContent,i=r.lastIndexOf("@");return i===-1||i>=n||i!==0&&r[i-1]!==" "?null:{begin:i,end:n,text:r,element:t}}function Fe(){var e=qr();if(e===null)return null;var t=0;if(typeof window.getSelection<"u"){var n=window.getSelection().getRangeAt(0),r=n.cloneRange();r.selectNodeContents(e),r.setEnd(n.endContainer,n.endOffset),t=r.toString().length}else if(typeof document.selection<"u"&&document.selection.type!="Control"){var i=document.selection.createRange(),o=document.body.createTextRange();o.moveToElementText(e),o.setEndPoint("EndToEnd",i),t=o.text.length}return{element:e,caretOffset:t}}function qr(){var e=document.getSelection().anchorNode;return(e==null?void 0:e.nodeType)==3?e:null}function Kr(e){var t=_.useState(!1),n=J(t,2),r=n[0],i=n[1],o=_.useState([]),s=J(o,2),l=s[0],c=s[1],u=_.useState(null),a=J(u,2),m=a[0],d=a[1],v=_.useCallback(function(){Wr(),c([])},[]),h=_.useCallback(Xe(de().mark(function k(){var L,w;return de().wrap(function(M){for(;;)switch(M.prev=M.next){case 0:if(L=Vr(),d(L),L!==null){M.next=6;break}c([]),M.next=12;break;case 6:return i(!0),M.next=9,e(L);case 9:w=M.sent,i(!1),c(w);case 12:case"end":return M.stop()}},k)})),[e]),y=_.useCallback(function(){var k=Xe(de().mark(function L(w){var C,M;return de().wrap(function(V){for(;;)switch(V.prev=V.next){case 0:if(typeof e=="function"){V.next=2;break}return V.abrupt("return");case 2:w.key==="Backspace"&&(C=Fe())!==null&&C!==void 0&&C.element.parentElement.hasAttribute("data-mention-id")?(M=Fe(),M.element.parentElement.remove()):["ArrowUp","ArrowDown","Esc","Escape"].includes(w.key)||h();case 3:case"end":return V.stop()}},L)}));return function(L){return k.apply(this,arguments)}}(),[h,e]),g=_.useCallback(function(){h()},[h]);return{mentionSearchText:m,mentionUsers:l,onKeyUp:y,onFocus:g,onSelectUser:v,loading:r}}var Gr=function(t,n){var r=t.users,i=t.mentionSearchText,o=t.onSelect,s=t.addEventListener,l=_.useState(0),c=J(l,2),u=c[0],a=c[1];_.useImperativeHandle(n,function(){return{prevUser:function(){a(function(y){return y===0?0:y-1})},nextUser:function(){a(function(y){return y===r.length-1?r.length-1:y+1})}}}),_.useEffect(function(){a(0)},[r]);function m(h,y){return'<span class="react-input-emoji--mention--item--name__selected" data-testid="metion-selected-word">'.concat(h,"</span>").concat(y)}var d=_.useMemo(function(){var h=i?i.substring(1).toLocaleLowerCase():"";return r.map(function(y){var g=y.name;if(i&&i.length>1)if(y.name.toLowerCase().startsWith(h))g=m(y.name.substring(0,h.length),y.name.substring(h.length));else{var k=y.name.split(" ");g=k.map(function(L){return L.toLocaleLowerCase().startsWith(h)?m(L.substring(0,h.length),L.substring(h.length)):L}).join(" ")}return Ge(Ge({},y),{},{nameHtml:g})})},[i,r]);function v(h){return function(y){y.stopPropagation(),y.preventDefault(),o(h)}}return _.useEffect(function(){var h=s("enter",function(y){y.stopPropagation(),y.preventDefault(),o(d[u])});return function(){h()}},[s,o,u,d]),z.createElement("ul",{className:"react-input-emoji--mention--list","data-testid":"mention-user-list"},d.map(function(h,y){return z.createElement("li",{key:h.id},z.createElement("button",{type:"button",onClick:v(h),className:"react-input-emoji--mention--item".concat(u===y?" react-input-emoji--mention--item__selected":""),onMouseOver:function(){return a(y)}},z.createElement("img",{className:"react-input-emoji--mention--item--img",src:h.image}),z.createElement("div",{className:"react-input-emoji--mention--item--name",dangerouslySetInnerHTML:{__html:h.nameHtml}})))}))},an=_.forwardRef(Gr);an.propTypes={users:ue.array.isRequired};var Yr=function(t){var n=t.searchMention,r=t.addEventListener,i=t.appendContent,o=t.addSanitizeFn,s=_.useRef(null),l=_.useState(!1),c=J(l,2),u=c[0],a=c[1],m=Kr(n),d=m.mentionSearchText,v=m.mentionUsers,h=m.loading,y=m.onKeyUp,g=m.onFocus,k=m.onSelectUser;_.useEffect(function(){o(function(w){var C=document.createElement("div");C.innerHTML=w;var M=Array.prototype.slice.call(C.querySelectorAll(".react-input-emoji--mention--text"));return M.forEach(function(O){C.innerHTML=C.innerHTML.replace(O.outerHTML,"@[".concat(O.dataset.mentionName,"](userId:").concat(O.dataset.mentionId,")"))}),C.innerHTML})},[o]),_.useEffect(function(){a(v.length>0)},[v]),_.useEffect(function(){function w(){a(!1)}return document.addEventListener("click",w),function(){document.removeEventListener("click",w)}},[]),_.useEffect(function(){var w=r("keyUp",y);return function(){w()}},[r,y]),_.useEffect(function(){function w(M){switch(M.key){case"Esc":case"Escape":a(!1);break}}var C=r("keyDown",w);return function(){C()}},[r]),_.useEffect(function(){var w=r("focus",g);return function(){w()}},[r,g]),_.useEffect(function(){if(u){var w=r("arrowUp",function(M){M.stopPropagation(),M.preventDefault(),s.current.prevUser()}),C=r("arrowDown",function(M){M.stopPropagation(),M.preventDefault(),s.current.nextUser()});return function(){w(),C()}}},[r,u]);function L(w){k(),i('<span class="react-input-emoji--mention--text" data-mention-id="'.concat(w.id,'" data-mention-name="').concat(w.name,'">@').concat(w.name,"</span> "))}return z.createElement(z.Fragment,null,h?z.createElement("div",{className:"react-input-emoji--mention--container"},z.createElement("div",{className:"react-input-emoji--mention--loading"},z.createElement("div",{className:"react-input-emoji--mention--loading--spinner"},"Loading..."))):u&&z.createElement("div",{className:"react-input-emoji--mention--container",onClick:function(C){return C.stopPropagation()}},z.createElement(an,{ref:s,mentionSearchText:d,users:v,onSelect:L,addEventListener:r})))};function ne(){var e=[];return{subscribe:function(n){return e.push(n),function(){e=e.filter(function(r){return r!==n})}},publish:function(n){e.forEach(function(r){return r(n)})},get currentListerners(){return e}}}function Xr(){var e=_.useMemo(function(){return{keyDown:ne(),keyUp:ne(),arrowUp:ne(),arrowDown:ne(),enter:ne(),focus:ne(),blur:ne()}},[]),t=_.useCallback(function(n,r){return e[n].subscribe(r)},[e]);return{addEventListener:t,listeners:e}}function Zr(){var e=_.useRef([]),t=_.useCallback(function(r){e.current.push(r)},[]),n=_.useCallback(function(r){var i=e.current.reduce(function(o,s){return s(o)},r);return i},[]);return{addPolluteFn:t,pollute:n}}function Jr(e,t){var n=e.onChange,r=e.onEnter,i=e.onResize,o=e.onClick,s=e.onFocus,l=e.onBlur,c=e.onKeyDown,u=e.theme,a=e.cleanOnEnter,m=e.placeholder,d=e.maxLength,v=e.keepOpened,h=e.inputClass,y=e.disableRecent,g=e.tabIndex,k=e.value,L=e.customEmojis,w=e.searchMention,C=e.buttonElement,M=e.borderRadius,O=e.borderColor,V=e.fontSize,le=e.fontFamily,B=_.useRef(null),b=Xr(),p=b.addEventListener,$=b.listeners,E=zt(),S=E.addSanitizeFn,T=E.sanitize,A=E.sanitizedTextRef,F=Zr(),W=F.addPolluteFn,P=F.pollute,I=_.useCallback(function(){var D=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"";B.current!==null&&(B.current.html=Et(D),A.current=D)},[A]),U=_.useCallback(function(D){I(D)},[I]),ee=Zn(B,i,n);Xn({ref:t,setValue:U,textInputRef:B,emitChange:ee}),_.useEffect(function(){A.current!==k&&U(k)},[A,U,k]),_.useEffect(function(){I()},[I]),_.useEffect(function(){function D(ie){if(typeof d<"u"&&ie.key!=="Backspace"&&B.current!==null&&Je(B.current)>=d&&ie.preventDefault(),ie.key==="Enter"&&B.current){ie.preventDefault();var ln=T(B.current.html);return ee(A.current),typeof r=="function"&&$.enter.currentListerners.length===0&&r(ln),a&&$.enter.currentListerners.length===0&&I(""),typeof c=="function"&&c(ie.nativeEvent),!1}return typeof c=="function"&&c(ie.nativeEvent),!0}var K=p("keyDown",D);return function(){K()}},[p,a,ee,$.enter.currentListerners.length,d,r,c,T,A,I]),_.useEffect(function(){function D(){typeof o=="function"&&o(),typeof s=="function"&&s()}var K=p("focus",D);return function(){K()}},[p,o,s]),_.useEffect(function(){function D(){typeof l=="function"&&l()}var K=p("blur",D);return function(){K()}},[p,l]);function he(D){T(D),ee(A.current)}function re(D){typeof d<"u"&&B.current!==null&&Je(B.current)>=d||B.current!==null&&B.current.appendContent(D)}function te(D){D.clipboardData.setData("text",A.current),D.preventDefault()}function cn(D){D.preventDefault();var K;D.clipboardData&&(K=D.clipboardData.getData("text/plain"),K=P(K),document.execCommand("insertHTML",!1,K))}return z.createElement("div",{className:"react-emoji"},z.createElement(Yr,{searchMention:w,addEventListener:p,appendContent:re,addSanitizeFn:S}),z.createElement(er,{ref:B,onCopy:te,onPaste:cn,onBlur:$.blur.publish,onFocus:$.focus.publish,onArrowUp:$.arrowUp.publish,onArrowDown:$.arrowDown.publish,onKeyUp:$.keyUp.publish,onKeyDown:$.keyDown.publish,onEnter:$.enter.publish,placeholder:m,style:{borderRadius:M,borderColor:O,fontSize:V,fontFamily:le},tabIndex:g,className:h,onChange:he}),z.createElement(Ur,{theme:u,keepOpened:v,disableRecent:y,customEmojis:L,addSanitizeFn:S,addPolluteFn:W,appendContent:re,buttonElement:C}))}var sn=_.forwardRef(Jr);sn.defaultProps={theme:"auto",height:30,placeholder:"Type a message",borderRadius:21,borderColor:"#EAEAEA",fontSize:15,fontFamily:"sans-serif",tabIndex:0,customEmojis:[]};const Qr=({chat:e,currentUser:t,setSendMessage:n,receiveMessage:r,online:i})=>{const[o,s]=_.useState(null),[l,c]=_.useState([]),[u,a]=_.useState(""),m=oe(w=>w.token),d=oe(w=>w.user._id),v=_.useRef(null),h=_.useRef(null),y=dn();_.useEffect(()=>{r!==null&&(r==null?void 0:r.chatId)===(e==null?void 0:e._id)&&c(w=>[...w,r])},[r]),_.useEffect(()=>{(async()=>{try{const{messages:C}=await vn(e._id,m);c(C)}catch(C){console.log(C)}})()},[e,m]),_.useEffect(()=>{var M;const w=(M=e==null?void 0:e.members)==null?void 0:M.find(O=>O!==t);(async()=>{try{const O=await Ct(w,m);s(O)}catch(O){console.log(O)}})()},[e,t,m]);const g=async()=>{try{await gn({chatId:e._id,senderId:d,message:u},m),c(C=>[...C,{senderId:d,message:u}]),a("")}catch(C){console.log(C)}const w=e.members.find(C=>C!==d);n({chatId:e._id,senderId:d,message:u,receiverId:w})},k=()=>{var w,C;(C=(w=v.current)==null?void 0:w.files)==null||C[0]},L=()=>{var w;(w=v.current)==null||w.click()};return _.useEffect(()=>{var w;(w=h.current)==null||w.scrollIntoView({behavior:"smooth"})},[l]),x.jsxs("div",{className:"ChatBox-container",children:[e?x.jsxs(x.Fragment,{children:[x.jsx("div",{className:"chat-header",children:x.jsx("div",{className:"follower",children:x.jsxs(ve,{children:[x.jsxs(ve,{sx:{justifyContent:"flex-start"},children:[o!=null&&o.dp?x.jsx("div",{className:"profile-picture",children:x.jsx(_e,{alt:o.userName,src:o.dp,sx:{m:"10px"}})}):x.jsx(_e,{alt:o==null?void 0:o.userName,sx:{m:"10px"}}),x.jsxs(ve,{flexDirection:"column",children:[x.jsx("div",{style:{display:"flex",flexDirection:"column"},children:x.jsx("span",{className:"name",style:{fontSize:"0.8rem",fontStyle:"initial"},children:o==null?void 0:o.userName})}),i?x.jsx(We,{children:"Online"}):x.jsx(We,{children:"Offline"})]})]}),x.jsx(Ee,{onClick:()=>y("/chat/video_call"),children:x.jsx(xn,{})})]})})}),x.jsx("div",{className:"chat-body",children:l.map((w,C)=>x.jsxs("div",{ref:C===l.length-1?h:null,className:w.senderId===t?"message own":"message",children:[x.jsx("span",{children:w.message}),x.jsx("span",{children:Rn(w.createdAt)})]},C))}),x.jsxs("div",{className:"chat-sender",children:[x.jsx("input",{type:"file",ref:v,style:{display:"none"},accept:"image/*",onChange:k}),x.jsx(Ee,{onClick:L,children:x.jsx(kn,{})}),x.jsx(sn,{value:u,onChange:a}),x.jsx(Ee,{onClick:g,children:x.jsx(wn,{})})]})]}):x.jsx("div",{style:{textAlign:"center",marginTop:"50px",fontSize:"1.5rem",color:"#888"},children:"Tap to chat"}),x.jsx(yn,{position:"bottom-left"})]})},ui=()=>{const[e,t]=_.useState([]),[n,r]=_.useState([]),[i,o]=_.useState(null),[s,l]=_.useState(null),c=oe(g=>{var k;return(k=g.user)==null?void 0:k._id}),u=oe(g=>g.token),a=oe(g=>g.notifications),m=_.useRef(null),d=oe(g=>g.currentchat),v=fn(),h=g=>{console.log(g),v(mn({currentchat:g}))};_.useEffect(()=>(m.current=hn("https://connectfy.online/api"),c&&(m.current.emit("new-user-add",c),m.current.on("get-users",g=>{r(g),console.log(g)})),()=>{m.current&&m.current.disconnect()}),[c]),_.useEffect(()=>{var g;i!==null&&((g=m.current)==null||g.emit("send-message",i))},[i]),_.useEffect(()=>{var g;(g=m.current)==null||g.on("receive-message",k=>{console.log("recivee"),l(k),console.log("Received message:",k)})},[]),_.useEffect(()=>{v(pn())},[a]),_.useEffect(()=>{c&&(async()=>{try{const{chats:k}=await bn(c,u);t(k)}catch(k){throw k}})()},[d]);const y=g=>{const k=g==null?void 0:g.members.find(w=>w!==c);return!!(n==null?void 0:n.find(w=>w.userId===k))};return x.jsxs(x.Fragment,{children:[x.jsx(_n,{}),x.jsxs("div",{className:"Chat",children:[x.jsx("div",{className:"Left-side-chat",children:x.jsxs("div",{className:"Chat-container",children:[x.jsx("h2",{children:"Chats"}),x.jsx("div",{className:"Chat-list",children:e.map(g=>x.jsx("div",{onClick:()=>h(g),style:{cursor:"pointer"},children:x.jsx(Cn,{data:g,userId:c,token:u,online:y(g)})},g._id))})]})}),x.jsx("div",{className:"Right-side-chat",children:x.jsx("div",{children:x.jsx(Qr,{chat:d,currentUser:c,setSendMessage:o,receiveMessage:s,online:y(d)})})})]})]})};export{ui as default};

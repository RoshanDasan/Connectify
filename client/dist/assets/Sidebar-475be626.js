import{g as ae,d as re,k as W,e as ie,_ as g,K as oe,h as L,r as c,i as ne,l as le,j as e,m as ce,n as de,c as K,H as he,I as ue,q as X,u as V,B as w,L as M,M as me,a as pe,N as xe}from"./index-bddea3d7.js";import{r as P,c as fe}from"./userConnection-6a739ba4.js";import{F as G}from"./DisplayFlex-ab22cac9.js";import{T as N,I as ge,Q as U,L as C}from"./api-a7898673.js";import{A as $}from"./Avatar-3591507f.js";import{m as je,a as I,L as m,b as x,H as ve,c as p,S as be,D as ke,E as we}from"./makeStyles-f1076883.js";import{M as Se,B as ye}from"./Navbar-9cc73e21.js";import{T as Ce}from"./TextField-0042dcdd.js";function Ie(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function Ne(t){return parseFloat(t)}function Re(t){return ae("MuiSkeleton",t)}re("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const _e=["animation","className","component","height","style","variant","width"];let S=t=>t,q,B,F,z;const Te=t=>{const{classes:s,variant:r,animation:l,hasChildren:d,width:o,height:i}=t;return de({root:["root",r,l,d&&"withChildren",d&&!o&&"fitContent",d&&!i&&"heightAuto"]},Re,s)},De=W(q||(q=S`
  0% {
    opacity: 1;
  }
...
`)),E=!0),e.jsx(Ue,g({ref:r},s))});var R={},qe=ue;Object.defineProperty(R,"__esModule",{value:!0});var Q=R.default=void 0,Be=qe(he()),Fe=e,ze=(0,Be.default)((0,Fe.jsx)("path",{d:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"}),"Close");Q=R.default=ze;const Ae=()=>{const{_id:t,requests:s}=X(o=>o.user),r=V();c.useEffect(()=>{},[s]);const l=async(o,i,n)=>{console.log(n);const h=await P(o,i,n);r(M({id:i})),U.success(h),r(me({followers:i}))},d=async(o,i,n)=>{console.log(n);const h=await P(o,i,n);r(M({id:i})),U.success(h)};return e.jsx(e.Fragment,{children:s.map(({id:o,userName:i,dp:n})=>e.jsxs(G,{sx:{marginBottom:2},children:[n?e.jsx("div",{className:"profile-picture",children:e.jsx($,{alt:i,src:n})}):e.jsx($,{alt:i}),e.jsx("div",{style:{width:130},children:e.jsx(N,{variant:"h6",children:`${i} started following you`})}),e.jsx(w,{variant:"contained",color:"info",onClick:()=>l(t,o,"accept"),children:"accept"}),e.jsx(ge,{onClick:()=>d(t,o,"reject"),children:e.jsx(Q,{})})]},o))})},H=240,Ee=je(t=>({root:{display:"flex"},drawer:{width:H,flexShrink:0},drawerPaper:{width:H,backgroundColor:t.palette.background.default},toolbar:t.mixins.toolbar,listItem:{"&:hover":{backgroundColor:t.palette.background.default}},listItemText:{fontWeight:t.typography.fontWeightBold},searchDrawer:{width:300,flexShrink:0,marginLeft:"auto"},searchDrawerPaper:{width:350,padding:20,backgroundColor:t.palette.background.default},searchField:{marginTop:t.spacing(2),marginLeft:t.spacing(2),marginRight:t.spacing(2)}})),Ye=()=>{const[t,s]=c.useState(!1),[r,l]=c.useState(""),[d,o]=c.useState([]),[i,n]=c.useState("userName"),[h,y]=c.useState([]),[j,v]=c.useState(!1),[b,k]=c.useState(!1),{_id:Y,requests:_}=X(u=>u.user),J={user:!0},a=Ee(),f=pe(),Z=V(),T=()=>{s(!t)},D=()=>{v(!j)},ee=u=>{l(u.target.value)},te=async()=>{k(!0);var u=await fe(r,i);y(u),k(!1)};c.useEffect(()=>{te()},[r]),c.useEffect(()=>{h&&o(h)},[h]);const se=()=>{Z(xe()),f("/")};return e.jsxs("div",{className:a.root,children:[e.jsxs(I,{className:a.drawer,variant:"permanent",classes:{paper:a.drawerPaper},children:[e.jsx("div",{className:a.toolbar}),e.jsxs(C,{children:[e.jsxs(m,{button:!0,className:a.listItem,children:[e.jsx(x,{children:e.jsx(ve,{})}),e.jsx(p,{primary:"Home",classes:{primary:a.listItemText},onClick:()=>f("/")})]}),e.jsxs(m,{button:!0,className:a.listItem,children:[e.jsx(x,{children:e.jsx(be,{})}),e.jsx(p,{primary:"Search",classes:{primary:a.listItemText},onClick:T})]}),e.jsxs(m,{button:!0,className:a.listItem,onClick:()=>f("/chat"),children:[e.jsx(x,{children:e.jsx(Se,{})}),e.jsx(p,{primary:"Message",classes:{primary:a.listItemText}})]}),e.jsxs(m,{button:!0,className:a.listItem,children:[e.jsx(x,{children:_.length?e.jsx(ye,{color:"info",badgeContent:_.length,children:e.jsx(A,{sx:{fontSize:"25px"}})}):e.jsx(A,{sx:{fontSize:"25px"}})}),e.jsx(p,{primary:"Requests",classes:{primary:a.listItemText},onClick:D})]}),e.jsxs(m,{button:!0,className:a.listItem,onClick:()=>f(`/profile/${Y}`,{state:J}),children:[e.jsx(x,{children:e.jsx($e,{})}),e.jsx(p,{primary:"Profile",classes:{primary:a.listItemText}})]})]}),e.jsx(ke,{}),e.jsx(C,{children:e.jsxs(m,{button:!0,className:a.listItem,onClick:se,children:[e.jsx(x,{children:e.jsx(we,{})}),e.jsx(p,{primary:"Logout",classes:{primary:a.listItemText}})]})})]}),e.jsxs(I,{className:a.searchDrawer,anchor:"left",open:t,onClose:T,classes:{paper:a.searchDrawerPaper},children:[e.jsx(N,{variant:"h3",children:"Search"}),e.jsx("div",{className:a.toolbar}),e.jsxs(G,{children:[e.jsx(w,{variant:i==="userName"?"outlined":"text",onClick:()=>n("userName"),children:"User"}),e.jsx(w,{variant:i==="gender"?"outlined":"text",onClick:()=>n("gender"),children:"Gender"}),e.jsx(w,{variant:i==="city"?"outlined":"text",onClick:()=>n("city"),children:"Location"})]}),e.jsx(Ce,{onKeyUp:ee,className:a.searchField,label:"Search.....",variant:"outlined",size:"small",fullWidth:!0}),b?e.jsxs(e.Fragment,{children:[e.jsx(O,{sx:{margin:".2rem",width:"95%",height:"50px"}}),e.jsx(O,{sx:{margin:".2rem",width:"95%",height:"50px"}})]}):d.length>0&&e.jsx(C,{children:d.map(u=>e.jsx(m,{button:!0,className:a.listItem,children:e.jsx(p,{primary:u.userName,classes:{primary:a.listItemText},onClick:()=>f(`/profile/${u._id}`)})},u._id))})]}),e.jsxs(I,{className:a.searchDrawer,anchor:"left",open:j,onClose:D,classes:{paper:a.searchDrawerPaper},children:[e.jsx(N,{variant:"h3",children:"Notifications"}),e.jsx("div",{className:a.toolbar}),e.jsx(Ae,{})]})]})};export{Ue as S,Ye as a,Q as d};
